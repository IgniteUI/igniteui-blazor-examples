...
function updateIG(cb) {
    ...
    let packageUpgrades = [
        ...
        { version: "25.2.83", name: "IgniteUI.Blazor.Trial" },
        { version: "25.2.83", name: "IgniteUI.Blazor.Documents.Core.Trial" },
        { version: "25.2.83", name: "IgniteUI.Blazor.Documents.Excel.Trial" },
