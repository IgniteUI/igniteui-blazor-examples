...
function updateIG(cb) {
    ...
    // { version: "26.1.51", name: "IgniteUI.Blazor.Trial" }, // ALWAYS use trial packages
    ...
    let packageUpgrades = [
        ...
        { version: "26.1.51", name: "IgniteUI.Blazor.Trial" },
        { version: "26.1.51", name: "IgniteUI.Blazor.Documents.Core.Trial" },
        { version: "26.1.51", name: "IgniteUI.Blazor.Documents.Excel.Trial" },
