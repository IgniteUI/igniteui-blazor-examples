...
function updateIG(cb) {
    ...
    let packageUpgrades = [
        ...
        { version: "26.1.86", name: "IgniteUI.Blazor.Trial" },
        { version: "26.1.86", name: "IgniteUI.Blazor.Documents.Core.Trial" },
        { version: "26.1.86", name: "IgniteUI.Blazor.Documents.Excel.Trial" },
