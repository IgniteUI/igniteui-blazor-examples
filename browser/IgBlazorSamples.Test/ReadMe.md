...
- Open a Powershell terminal in the `./browser/IgBlazorSamples.Test/bin/Debug/net10.0` folder.
...
You can run it from the `./browser/IgBlazorSamples.Test` folder as well, but you will need to prefix the path to it: `bin/Debug/net10.0/playwright.ps1 install`
