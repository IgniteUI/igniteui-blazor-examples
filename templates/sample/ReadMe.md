This folder contains implementation of {PlatformName} application with example of {SampleDisplayName} using [{ComponentName}](https://www.infragistics.com/products/ignite-ui-blazor/blazor/components/general-getting-started.html) component.
