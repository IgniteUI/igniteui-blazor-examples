...
public class HealthDataForNorwayItem
{
...
public class HealthDataForNorway
    : List<HealthDataForNorwayItem>
{
    public HealthDataForNorway()
    {
        this.Add(new HealthDataForNorwayItem()
        {
            Year = 1985,
