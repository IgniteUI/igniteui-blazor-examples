    ...
    : List<EnergyRenewableConsumptionItem>
{
    public EnergyRenewableConsumption()
    {
        ...
        this.Add(new EnergyRenewableConsumptionItem() { Location = @"Brazil", Year = 2019, Hydro = 399.3, Solar = 5.5, Wind = 55.83, Other = 56.25 });
        this.Add(new EnergyRenewableConsumptionItem() { Location = @"Canada", Year = 2019, Hydro = 381.98, Solar = 4.3, Wind = 34.17, Other = 10.81 });
    }
}
