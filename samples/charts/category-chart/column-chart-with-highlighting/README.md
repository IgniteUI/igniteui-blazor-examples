This folder contains implementation of Blazor application with example of Column Chart With Highlighting using [Category Chart](https://www.infragistics.com/products/ignite-ui-blazor/blazor/components/general-getting-started.html) component.
