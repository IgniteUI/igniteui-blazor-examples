    ...
    : List<EnergyGlobalDemandItem>
{
    public EnergyGlobalDemand()
    {
        ...
        this.Add(new EnergyGlobalDemandItem() { Value = 11, Category = @"Lighting", Summary = @"Lighting 11%" });
        this.Add(new EnergyGlobalDemandItem() { Value = 15, Category = @"Other", Summary = @"Other 15%" });
    }
}
