This folder contains implementation of Blazor application with example of Type Direction using [Radial Gauge](https://www.infragistics.com/products/ignite-ui-blazor/blazor/components/general-getting-started.html) component.
