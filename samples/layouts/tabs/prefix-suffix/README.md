...
This folder contains implementation of Blazor application with example of Prefix Suffix feature using [Tabs](https://www.infragistics.com/products/ignite-ui-blazor/blazor/components/general-getting-started.html) component.
...
<html lang="en" xmlns="http://www.w3.org/1999/xhtml">
    <body>
        ...
        <a target="_blank" href="https://infragistics.com/blazor-client/samples/layouts/tabs/prefix-suffix" rel="noopener noreferrer">
