    ...
    public static class PersonDataSource
    {
        ...
        public static List<PersonLocation> GetLocations()
        {
            var locations = new List<PersonLocation> {
                ...
                new PersonLocation { Latitude = 39.029, Longitude = 125.758, Country = "North-Korea", City = "Pyongyang" },
                ...
                new PersonLocation { Latitude = 37.542, Longitude = 126.935, Country = "South-Korea", City = "Seoul" },
