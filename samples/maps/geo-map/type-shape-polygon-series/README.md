...
This folder contains implementation of Blazor application with example of Type Shape Polygon Series feature using [Geographic Map](https://www.infragistics.com/products/ignite-ui-blazor/blazor/components/general-getting-started.html) component.
