...
namespace Infragistics.Samples
{
    public class HGriddDataItem
    {
        ...
        public List<HGridDataItem_LocationsItem> Locations { get; set; }
    }
    public class HGridDataItem_LocationsItem
    {
        public string Shop { get; set; }
        public string LastInventory { get; set; }
    }

    public class HGridData
        : List<HGriddDataItem>
    {

        private readonly List<HGriddDataItem> items;

        public HGridData()
        {
            items = GenerateSampleData();
        }
        private static List<HGriddDataItem> GenerateSampleData()
        {
            var sampleData = new List<HGriddDataItem>();

            sampleData.Add(new HGriddDataItem()
            {
                ProductID = 1,
                ProductName = @"Chai",
                SupplierID = 1,
                ...
                Rating = 5,
                Locations = new List<HGridDataItem_LocationsItem>()
            {
                new()
                {
                    Shop = @"Fun-Tasty Co.",
        ...
        public Task<List<HGriddDataItem>> GetData(int index, int perPage)
        {
