...
namespace Infragistics.Samples
{
    ...
    public class PortfolioData // LiveFinancialData
    {
        ...
        public static List<PortfolioInfo> Create(int count)
        {
            ...
            Console.WriteLine("LiveFinancialData " + dataItems.Count);
            return dataItems;
        }
        ...
        //TODO
        //public static UpdateResponse UpdateRandomPrices2(List<object> data)
        //{
        ...
        //    //    y++;
        //    //}
        //    return new UpdateResponse(); // { Data = data, RecordsUpdated = y };
        //}
